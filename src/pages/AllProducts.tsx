            ...
            {!isCategoryLoading ?
              <>
                {content ?
                  ...
                  // Gender selection
                  <div className='w-full flex flex-col space-y-5'>
                    <button onClick={() => setGender("all")} className={`w-full px-[10px] py-[15px] rounded-[10px] flex items-center justify-between cursor-pointer toy-border ${gender === "all" ? "category-active" : ""}`}><p className="font-medium">{translations.allProducts.all}</p></button>
                    <button onClick={() => setGender("male")} className={`w-full px-[10px] py-[15px] rounded-[10px] flex items-center justify-between cursor-pointer toy-border ${gender === "male" ? "category-active" : ""}`}><p className="font-medium">{translations.allProducts.men}</p></button>
                    <button onClick={() => setGender("female")} className={`w-full px-[10px] py-[15px] rounded-[10px] flex items-center justify-between cursor-pointer toy-border ${gender === "female" ? "category-active" : ""}`} ><p className="font-medium">{translations.allProducts.girl}</p></button>
                  </div>
                }
              </>
              :
