        ...
        <>
            ...
            <div className='HeroBg mb-[100px] relative overflow-hidden py-[100px] hidden md:block lg:hidden'>
                <div className='ml-[100px]'>
                    ...
                    <button onClick={() => navigate(PATH.allproducts)} className='max-w-[300px] py-[5px] px-4 rounded-lg bg-white cursor-pointer font-medium text-[25px] text-[#3E3E3E] hover:bg-gray-100 transition-colors'>
                        {translations.Hero.buttonText}
                    </button>
                </div>
            </div>
