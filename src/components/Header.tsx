...
import { BasketIcon, CallIcon, ExitIcon, HeaderFacebookIcon, HeaderInstagramIcon, HeaderTelegramIcon, MailIcon, MenuIcon } from "../assets/Icon"
    ...
    return (
        <>
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <div className='flex items-center gap-4 md:gap-6 lg:gap-[35px]'>
                                <div className='cursor-pointer relative'>
                                    <Link to={PATH.basket}>
                                        <Badge count={shopCount > 0 ? shopCount : null} size="small">
                                            <BasketIcon />
                                        </Badge>
                                    </Link>
                                </div>
            ...
            <header className='md:hidden w-full bg-white shadow-sm'>
                ...
                {mobileMenu && (
                    <div className='fixed top-[13%] right-[1%] w-[250px] h-auto max-h-[80vh] bg-white shadow-lg border-[1.5px] border-[#D9D9D9] z-40 rounded-lg overflow-y-auto'>
                        <div className='p-4'>
                            <nav className='mb-6'>
